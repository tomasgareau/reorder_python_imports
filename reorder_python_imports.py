    ...
    **sort_kwargs: Any,
    ...
    def _import_type_switches(
        ...
        return (
            ...
            and last_import_obj is not None
...
def _get_steps(
    ...
    **sort_kwargs: Any,
    ...
    yield functools.partial(
        remove_duplicated_imports, allow_implicit_duplicates=allow_implicit_duplicates
    )
